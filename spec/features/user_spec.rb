...
RSpec.feature "User" do
  context "As a new user" do
    scenario "I can sign up and sign in" do
      ...
      within ".new_user" do
        fill_in :user_email, with: "new_user@mpact.com"
  ...
  context "As a user" do
    ...
    scenario "I can edit my profile" do
      ...
      within ".flash" do
        notice = I18n.t("users.update.success", email: "user@mpact.com")
    ...
    scenario "I can not manage users, moderate or administer the forum" do
      ...
      user = User.create(email: "no_access_user@mpact.com", password: "123456", short_name: "user", last_sign_in_at: Time.zone.now)
  ...
  context "As a moderator" do
    let(:moderator) { User.create(email: "moderator@mpact.com", password: "123456", short_name: "moderator", last_sign_in_at: Time.zone.now, volunteer: true) }

    scenario "I can not manage users or forums, I can moderate posts" do
      login_as moderator

      user = User.create!(email: "another_user@mpact.com", password: "123456", short_name: "user", last_sign_in_at: Time.zone.now)
      Thredded::Messageboard.create!(name: "Test board")
      visit "/"
  ...
  context "As an admin" do
    ...
    scenario "I can manage other users" do
      user = User.create(email: "other_user@mpact.com", password: "123456", short_name: "user", last_sign_in_at: Time.zone.now)
      ...
      within ".users" do
        ...
        expect(rows[1]).to have_content "admin@mpact.com admin #{today}"
        expect(rows[2]).to have_content "other_user@mpact.com user #{today}"
      end
